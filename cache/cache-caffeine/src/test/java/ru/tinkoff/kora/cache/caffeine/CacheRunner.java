...
abstract class CacheRunner extends Assertions {
    ...
    ApplicationGraphDraw createGraphDraw(Class<?> app, Class<?>... targetClasses) throws Exception {
        try {
            ...
            classes.add(app);
            var classLoader = TestUtils.annotationProcess(classes, new KoraAppProcessor(), new AopAnnotationProcessor(), new CacheKeyAnnotationProcessor(), new ConfigRootAnnotationProcessor(), new ConfigSourceAnnotationProcessor());
