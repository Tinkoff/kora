...
public abstract class CacheRunner extends Assertions {
    ...
    protected static ApplicationGraphDraw createGraphDraw(Class<?> app, Class<?>... targetClasses) throws Exception {
        try {
            ...
            classes.add(app);
            var classLoader = TestUtils.annotationProcess(classes, new KoraAppProcessor(), new JsonAnnotationProcessor(), new AopAnnotationProcessor(), new CacheAnnotationProcessor(), new ConfigSourceAnnotationProcessor());
