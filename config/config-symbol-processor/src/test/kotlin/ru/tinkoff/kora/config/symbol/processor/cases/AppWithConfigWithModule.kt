...
@KoraApp
interface AppWithConfigWithModule : DefaultConfigExtractorsModule {
    ...
    fun mockLifecycle(
        @Tag(DataClassConfig::class) recordConfig: ValueOf<DataClassConfig>,
        @Tag(ClassConfig::class) pojoConfig: ValueOf<ClassConfig>
    ): MockLifecycle {
