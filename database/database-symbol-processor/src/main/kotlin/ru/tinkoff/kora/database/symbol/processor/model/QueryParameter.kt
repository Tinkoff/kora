...
sealed interface QueryParameter {
    ...
    data class ParameterWithMapper(override val name: String, override val type: KSType, override val variable: KSValueParameter, val mappingData: MappingData) : QueryParameter
