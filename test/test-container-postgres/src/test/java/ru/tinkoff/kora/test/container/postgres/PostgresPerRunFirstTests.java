...
public class PostgresPerRunFirstTests {
    ...
    void firstConnection(@ContainerPostgresConnection PostgresConnection connection) {
        ...
        if(PostgresPerRunSecondTests.perRunConnection != null) {
            assertEquals(perRunConnection, PostgresPerRunSecondTests.perRunConnection);
        }
    }
