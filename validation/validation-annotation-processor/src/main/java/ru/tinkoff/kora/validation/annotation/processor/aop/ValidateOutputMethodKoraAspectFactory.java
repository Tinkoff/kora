...
public class ValidateOutputMethodKoraAspectFactory implements KoraAspectFactory {

    @Override
    public Optional<KoraAspect> create(ProcessingEnvironment processingEnvironment) {
        return Optional.of(new ValidateOutputMethodKoraAspect(processingEnvironment));
    }
}
