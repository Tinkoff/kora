...
import ru.tinkoff.kora.resilient.kora.circuitbreaker.CircuitBreaker.State;
...
class SimpleCircuitBreakerTests extends Assertions {
    ...
    void switchFromClosedToOpen() {
        ...
        final CircuitBreakerConfig.NamedConfig config = new $CircuitBreakerConfig_NamedConfig_ConfigValueExtractor.NamedConfig_Impl(
            30, WAIT_IN_OPEN, 3, 10L, 8L, SimpleCircuitBreakerPredicate.class.getCanonicalName());
        final SimpleCircuitBreaker circuitBreaker = new SimpleCircuitBreaker("default", config, new SimpleCircuitBreakerPredicate(), new NoopCircuitBreakerMetrics());
    ...
    void switchFromClosedToOpenForMinimumNumberOfCalls() {
        // given
        final CircuitBreakerConfig.NamedConfig config = new $CircuitBreakerConfig_NamedConfig_ConfigValueExtractor.NamedConfig_Impl(
            100, WAIT_IN_OPEN, 1, 2L, 2L, SimpleCircuitBreakerPredicate.class.getCanonicalName());
        final SimpleCircuitBreaker circuitBreaker = new SimpleCircuitBreaker("default", config, new SimpleCircuitBreakerPredicate(), new NoopCircuitBreakerMetrics());
    ...
    void switchFromOpenToHalfOpenToOpen() {
        // given
        final CircuitBreakerConfig.NamedConfig config = new $CircuitBreakerConfig_NamedConfig_ConfigValueExtractor.NamedConfig_Impl(
            100, WAIT_IN_OPEN, 1, 1L, 1L, SimpleCircuitBreakerPredicate.class.getCanonicalName());
        final SimpleCircuitBreaker circuitBreaker = new SimpleCircuitBreaker("default", config, new SimpleCircuitBreakerPredicate(), new NoopCircuitBreakerMetrics());
    ...
    void switchFromClosedToOpenForCustomFailurePredicate() {
        ...
        final SimpleCircuitBreaker circuitBreaker = new SimpleCircuitBreaker("default", config, new CustomPredicate(), new NoopCircuitBreakerMetrics());
