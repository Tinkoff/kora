...
final class SimpleFallback implements Fallback {

    private static final Logger logger = LoggerFactory.getLogger(SimpleFallback.class);

    private final String name;
    private final FallbackMetrics metrics;
    private final FallbackPredicate failurePredicate;

    SimpleFallback(String name, FallbackMetrics metrics, FallbackPredicate failurePredicate) {
        this.name = name;
